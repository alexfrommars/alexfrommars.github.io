...
const FooterSection = props => {
  const footerInfo = [
    {
      imgPath: svgForm,
      description: 'Questions? Ask them here!',
      onClick: () => props.setCurrentModal('CONTACT'),
    },
    {
      imgPath: svgMail,
      description: 'lemonsrevenge@gmail.com',
      link: 'mailto:lemonsrevenge@gmail.com',
    },
    {
      imgPath: svgGithub,
      description: 'github.com/alexfrommars',
      link: 'https://github.com/alexfrommars',
    },
    {
      imgPath: svgPin,
      description: 'The Live Music Capital of the World',
      link: 'https://goo.gl/maps/6RQFYHhwaQ1m98uU8',
    },
  ];
