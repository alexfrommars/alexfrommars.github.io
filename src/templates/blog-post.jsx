  ...
  return (
    <Layout location={props.location}>
      <SectionContainer colorNumber="1" isTop>
        <SectionHeader colorNumber="1" text="Poolside Blog" link="/blog/" />
        <div css={styles.container}>
          ...
          <WhiteBox>
            <aside css={styles.comments}>
              <DiscussionEmbed shortname="poolside" config={disqusConfig} />
            </aside>
          </WhiteBox>
            ...
            <footer css={styles.footer}>
              ...
              <div>
                ...
                <p>
                  ...
                  I'm just a gal in awe of Shota Tamura's work on this site.
                </p>
              </div>
            </footer>
          </WhiteBox>
